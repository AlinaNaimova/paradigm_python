from seminar3hw.game_view import GameView
from seminar3hw.model_board import Board


class GameController:
    def __init__(self):
        self.view = GameView()  # создаем объект GameView для отображения игрового интерфейса

        self.model = Board()  # создаем объект Board для хранения состояния игры

    def play_game(self):
        self.view.print_welcome_message()  # выводим приветственное сообщение
